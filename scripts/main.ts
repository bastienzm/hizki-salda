...
// update upper bar
const left: number = answer.length - answered.size
const color: 'success' | 'danger' = left == 0 ? 'success' : 'danger';
const target: HTMLElement = document.querySelector('ion-badge');
